...
const GPTSearchBar = () => {
	...
	return (
		<div className="absolute top-[40%] left-[25%] w-[50%] grid xl:grid-cols-12 grid-cols-1">
			...
			/>
			<button className="text-white bg-red-500 p-2 m-6 cursor-pointer rounded-xl hover:bg-gray-300 hover:text-black hover:shadow-xl hover:brightness-110 hover:scale-120 transition-transform duration-300 ease-in-out xl:col-span-2 h-10 border border-black">
				{CONV.search[lang]}
			</button>
		</div>
	);
